...
function App() {
  ...
  const scale = (index, duration, multiplied = 1) => {
  ...
  const fadeOut = (index, duration, multiplied = 1) => {
    TweenLite.to(testimonialList.children[index],duration,{
      opacity: 0
    })
  }

  const fadeIn = (index, duration, multiplied = 1) =>{
    TweenLite.to(testimonialList.children[index],duration,{
      opacity: 1,
      delay : 1
    })
  ...
  return (
    <div className="testimonial-section">
      <div className="testimonial-container">
        <div onClick={prevSlise} className="arrows left">
          <span>
        ...
        <div onClick={nextSlise} className="arrows right">
          <span>
